...
public class Main {
	...
	public static void main(String[] args) {
		...
		CrearContraseñas [] passwords = new CrearContraseñas[cantidad];
		
		for(int i = 0; i < passwords.length; i++) {
			CrearContraseñas passwordGenerator = new CrearContraseñas();
			String contraseña = passwordGenerator.generar(longitud);
			System.out.println("- Contraseña "+(i+1)+": "+contraseña+" - Nivel de seguridad: "+passwordGenerator.nivelSeguridad(contraseña));
		}
